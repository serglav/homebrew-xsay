class Xsay < Formula
  ...
  url "https://github.com/serglav/xsay/archive/refs/tags/v3.2.2.tar.gz"
  sha256 "5585666d1930cc96a4932897b016b9772567cbe548f0025cf0a8c5669244c437"
  license "MIT"
  ...
  test do
    ...
    assert_match "3.2.2", shell_output("#{bin}/xsay --version")
  end
end
